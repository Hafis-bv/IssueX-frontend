...
export const ProjectCard = ({project, setProjects, creatingProjectId, setCreatingProjectId, editingId, setEditingId, newName, setNewName, deleteProject, updateProject}:ProjectCardProps) => {
    return (
        <li
